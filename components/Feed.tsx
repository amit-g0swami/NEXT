    ...
    return (
        <div className='col-span-7 max-h-screen overflow-scroll border-x scrollbar-hide lg:col-span-5'>
            <div className='flex items-center justify-between'>
                ...
                <RefreshIcon className='mr-5 mt-8 h-8 w-8 cursor-pointer text-twitter transition-all duration-500 ease-out hover:rotate-180 active:scale-125' onClick={handleRefresh} />
            </div>
            <div>
                <TweetBox />
            </div>
